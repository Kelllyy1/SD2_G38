...
def launch_app():
    ...
    Icons = QFontDatabase.addApplicationFont(
    ...
    window.setWindowTitle(" Hermes")

    # menubar
    menu_bar = QMenuBar()
    menu_bar.setObjectName("menu")
    # File menu
    ...
    interactButton = QPushButton("Next")
    ...
    titleTop = QLabel("Plant Configuration")
    ...
    titleBottom = QLabel("BESS Configuration")
    ...
    right_layout.addWidget(topRight, stretch=6)
    right_layout.addWidget(bottomRight, stretch=6)
    right_layout.addWidget(interact, stretch=1)

    topRight_layout.addWidget(tab, stretch=1)
    topRight_layout.addWidget(box, stretch=8)

    bottomRight_layout.addWidget(tabBottom, stretch=1)
    bottomRight_layout.addWidget(boxBottom, stretch=8)
    ...
    def print_inputs(self):
        """Function to print all input field values."""
        print("Filename:", self.interactInput.text())
        print("Number of Turbines:", self.plantInputsLeftNumberInput.text())

        location = "On-shore" if self.plantInputsLeftLocationTitle.isChecked() else "Off-shore"
        print("Location:", location)

        print("Blade Length:", self.turbineInputsLeftNumberInput.text())
        print("Energy Coefficient:", self.turbineInputsLeftLocationInput.text())

        print("Min Wind Speed:", self.weatherInputsLeftNumberInput.text())
        print("Max Wind Speed:", self.weatherInputsLeftLocationInput.text())
